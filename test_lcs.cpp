...
#endif    
    auto end = std::chrono::high_resolution_clock::now();
    std::cout << "test_lcs_brief :  " << (end - start) / 1us << "us\n";
    std::cout << "right = " << right << ", wrong = " << wrong << "\n";
}
...
void test_lcs_b()
{
    ...
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a5, a6, vo) != 3) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a7, a8, vo) != 7) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a9, a10, vo) != 9) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a11, a12, vo) != 10) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a13, a14, vo) != 10) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a15, a16, vo) != 11) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a17, a18, vo) != 11) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a19, a20, vo) != 10) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a21, a22, vo) != 11) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a23, a24, vo) != 11) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a25, a26, vo) != 10) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a27, a28, vo) != 8) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a29, a30, vo) != 10) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a31, a32, vo) != 9) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a33, a34, vo) != 10) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a35, a36, vo) != 12) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a37, a38, vo) != 11) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a39, a40, vo) != 10) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a41, a42, vo) != 11) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a43, a44, vo) != 12) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a45, a46, vo) != 12) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a47, a48, vo) != 15) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a49, a50, vo) != 14) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a51, a52, vo) != 12) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a53, a54, vo) != 9) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a55, a56, vo) != 6) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a57, a58, vo) != 3) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a59, a60, vo) != 4) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a61, a62, vo) != 4) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a63, a64, vo) != 6) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a65, a66, vo) != 8) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a67, a68, vo) != 9) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a69, a70, vo) != 8) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a71, a72, vo) != 9) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a73, a74, vo) != 8) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a75, a76, vo) != 8) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a77, a78, vo) != 9) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a79, a80, vo) != 9) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a81, a82, vo) != 8) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a83, a84, vo) != 9) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a85, a86, vo) != 8) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a87, a88, vo) != 9) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a89, a90, vo) != 10) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a91, a92, vo) != 12) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a93, a94, vo) != 10) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a95, a96, vo) != 9) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a97, a98, vo) != 6) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a99, a100, vo) != 6) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a101, a102, vo) != 3) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a103, a104, vo) != 3) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a105, a106, vo) != 4) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a107, a108, vo) != 5) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a109, a110, vo) != 7) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a111, a112, vo) != 7) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a113, a114, vo) != 8) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a115, a116, vo) != 8) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a117, a118, vo) != 8) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a119, a120, vo) != 7) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a121, a122, vo) != 7) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a123, a124, vo) != 6) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a125, a126, vo) != 6) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a127, a128, vo) != 6) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a129, a130, vo) != 5) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a131, a132, vo) != 7) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a133, a134, vo) != 6) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a135, a136, vo) != 6) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_b(a137, a138, vo) != 9) ? ++wrong : ++right;
    auto end = std::chrono::high_resolution_clock::now();
...
void test_lcs_n()
{
    ...
    auto start = std::chrono::high_resolution_clock::now();
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a1000, a1001, vo) != 1) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a1, a2, vo) != 1) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a3, a4, vo) != 1) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a5, a6, vo) != 3) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a7, a8, vo) != 7) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a9, a10, vo) != 9) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a11, a12, vo) != 10) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a13, a14, vo) != 10) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a15, a16, vo) != 11) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a17, a18, vo) != 11) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a19, a20, vo) != 10) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a21, a22, vo) != 11) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a23, a24, vo) != 11) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a25, a26, vo) != 10) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a27, a28, vo) != 8) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a29, a30, vo) != 10) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a31, a32, vo) != 9) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a33, a34, vo) != 10) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a35, a36, vo) != 12) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a37, a38, vo) != 11) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a39, a40, vo) != 10) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a41, a42, vo) != 11) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a43, a44, vo) != 12) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a45, a46, vo) != 12) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a47, a48, vo) != 15) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a49, a50, vo) != 14) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a51, a52, vo) != 12) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a53, a54, vo) != 9) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a55, a56, vo) != 6) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a57, a58, vo) != 3) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a59, a60, vo) != 4) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a61, a62, vo) != 4) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a63, a64, vo) != 6) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a65, a66, vo) != 8) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a67, a68, vo) != 9) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a69, a70, vo) != 8) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a71, a72, vo) != 9) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a73, a74, vo) != 8) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a75, a76, vo) != 8) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a77, a78, vo) != 9) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a79, a80, vo) != 9) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a81, a82, vo) != 8) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a83, a84, vo) != 9) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a85, a86, vo) != 8) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a87, a88, vo) != 9) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a89, a90, vo) != 10) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a91, a92, vo) != 12) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a93, a94, vo) != 10) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a95, a96, vo) != 9) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a97, a98, vo) != 6) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a99, a100, vo) != 6) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a101, a102, vo) != 3) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a103, a104, vo) != 3) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a105, a106, vo) != 4) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a107, a108, vo) != 5) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a109, a110, vo) != 7) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a111, a112, vo) != 7) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a113, a114, vo) != 8) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a115, a116, vo) != 8) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a117, a118, vo) != 8) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a119, a120, vo) != 7) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a121, a122, vo) != 7) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a123, a124, vo) != 6) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a125, a126, vo) != 6) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a127, a128, vo) != 6) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a129, a130, vo) != 5) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a131, a132, vo) != 7) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a133, a134, vo) != 6) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a135, a136, vo) != 6) ? ++wrong : ++right;
    std::fill(vo.begin(), vo.end(), -1);
    (lcs_n(a137, a138, vo) != 9) ? ++wrong : ++right;
    auto end = std::chrono::high_resolution_clock::now();
    std::cout << "test_lcs_n :  " << (end - start) / 1us << "us\n";
    std::cout << "right = " << right << ", wrong = " << wrong << "\n";
}